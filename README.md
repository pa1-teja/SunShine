...
or the user can simply tap on the Location icon on the right, which will GPS to locate the device, and use those coordinates to get the weather information of that place.
...
<br/>
The user will be navigated to the Detail screen where the app dislays a detail weather information such wind speed, humidity, pressure along with the date, High and Low temperatures of that particular day, when the user taps on any list item in the Main Screen.
<br/>
