...
public class Utility {
    ...
    // back into date objects for comparision/processing.
    ...
    public static String getDayName(Context context, long dateInMillis) {
        ...
        if (julianDay == currentJulianDay)
            ...
            Time time = new Time();
            time.setToNow();
            // Otherwise, the format is just the day os the week (e.g "Wednesday")
     ...
     *
     * @param context Context used to get the SharedPreference.
     */
