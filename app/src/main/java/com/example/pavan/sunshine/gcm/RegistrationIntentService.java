package com.example.pavan.sunshine.gcm;
...
public class RegistrationIntentService extends IntentService {
     ...
     * That's why you can see the value in logcat, and note it for the future use in the website.
     *
