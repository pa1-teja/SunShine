...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    private static final long DAY_IN_MILLIS = 100 * 60 * 60 * 24;
    ...
    public static void configurePeriodicSync(Context context, int syncInterval, int flexTime) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            // we can enable inexact times in our periodic sync.
     ...
     */
    public static void syncImmidiately(Context context) {
    ...
    public void onPerformSync(Account account, Bundle extras, String authority, ContentProviderClient provider, SyncResult syncResult) {
        ...
        try {
            ...
            final String OPEN_WEATHER_MAP_API_KEY = "fb29688b4c0181f127943ed3b473d8b0";
            ...
            // Create the request to OpenWeatherMap, and open the connectionurlConnection = (HttpURLConnection) url.openConnection();
    ...
    private void notifyWeather() {
        ...
        if (displayNotifications) {
            ...
            if (System.currentTimeMillis() - lastSync >= DAY_IN_MILLIS) {
                ...
                // Last sync was more than 1 day ago, lat's send a notification with the weather.
                ...
                if (cursor.moveToFirst()) {
                    ...
                    // NotificationCompatBuilder is very convienient way to build backward-compatibility for
                    ...
                    // Make something happen when the user clicks on the notification.
