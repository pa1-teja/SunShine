...
public class WeatherProvider extends ContentProvider {
    ...
    static {
        ...
        // This is an inner join which looks like weather INNER JOIN location ON weather.Location_id = location_id
    ...
    public int update(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        // by the update.
        final SQLiteDatabase liteDatabase = mOpenHelper.getWritableDatabase();
        final int match = sUriMatcher.match(uri);
        int rowsUpdated;
        ...
        switch (match) {
            case WEATHER:
                ...
                normalizeDate(values);
                rowsUpdated = liteDatabase.update(WeatherContract.WeatherEntry.TABLE_NAME,
                        values,
                        selection,
                        selectionArgs);
            ...
            case LOCATION:
                liteDatabase.beginTransaction();
                rowsUpdated = liteDatabase.update(WeatherContract.LocationEntry.TABLE_NAME, values, selection, selectionArgs);
                liteDatabase.setTransactionSuccessful();
                liteDatabase.endTransaction();
                break;
            default:
